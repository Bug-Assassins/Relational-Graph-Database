...
\begin{itemize}
 ...
 Since there can be multiple Select operations joined using conjunctions, all the individual condtions are combined using Intersection or Union of the individual result sets as reqired.
 ...
 Through this lists, we get a list of child nodes corresponding to the filtered parent nodes. Next the model operates on the child table and gets the result set by using the Select operation.
